...
/**
 * Strings for component 'admin', language 'fr', version '3.11'.
 *
 * @package     admin
 * @category    string
...
$string['configfilternavigationwithsystemcontext'] = 'L\'utilisation normal du filtrage est liée au contexte dans lequel il est utilisé (par exemple dans un cours), mais pour la navigation dans le site, tout filtrer explicitement au niveau système peut améliorer la performance lors de l\'utilisation du filtrage sur « Contenu et titres ».';
...
$string['filternavigationwithsystemcontext'] = 'Filtrer la navigation au niveau du contexte système';
