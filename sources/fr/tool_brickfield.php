...
/**
 * Strings for component 'tool_brickfield', language 'fr', version '3.11'.
 *
...
$string['checkdesc:noheadings'] = 'L\'absence de titres rend le contenu moins structuré et plus difficile à lire.';
...
$string['contentthree'] = 'Fournir à vos élèves des contenus dans des formats accessibles, notamment en audio, en ePub et en braille électronique.';
...
$string['error:nocoursespecified'] = 'Ce rapport de synthèse nécessite un identifiant de cours valide. Veuillez accéder à la boîte à outils d\'accessibilité à partir d\'un cours, via le menu d\'actions, qui fournira alors cet identifiant de cours requis.';
...
$string['privacy:metadata'] = 'Le plugin de rapport sur les contrôles d\'accessibilité ne stocke aucune donnée personnelle.';
...
$string['titleall'] = 'Infos d\'erreurs : tous les cours vérifiés ({$a->count} cours)';
...
$string['titleerrorsall'] = 'Infos d\'erreurs : tous les cours vérifiés ({$a->count} cours)';
$string['titleerrorscount'] = 'Infos d\'erreurs (affichage des {$a->count} premières erreurs) :';
$string['titleerrorspartial'] = 'Infos d\'erreurs : cours {$a->name}';
$string['titlepartial'] = 'Infos d\'erreurs : cours {$a->name}';
...
$string['validationerror'] = 'La validation de la clé d\'enregistrement a échoué. Vérifiez que l\'URL et les clés de votre site enregistré sont correctes.';
