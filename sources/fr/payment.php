...
/**
 * Strings for component 'payment', language 'fr', version '3.11'.
 *
 * @package     payment
 * @category    string
...
$string['accountname_help'] = 'Le nom sous lequel apparaîtra ce compte pour les enseignants ou les gestionnaires qui mettent en place des paiements (par exemple dans le plugin d\'inscription au cours).';
