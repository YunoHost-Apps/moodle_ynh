...
$string['bigbluebuttonbn:meeting'] = 'Créer les instances permettant les réunions en direct';
$string['bigbluebuttonbn:recording'] = 'Créer des instances permettant l\'enregistrement';
...
$string['config_clienttype_default_description'] = 'Choisir entre le client Adobe Flash classique ou le nouveau client HTML5.';
$string['config_clienttype_description'] = 'Ce paramètre active/désactive le choix du client web pour chaque salle.';
...
$string['config_recordings_deleted_default_description'] = 'Si ce réglage est activé, la table d\'enregistrements inclura les enregistrements des activités supprimées, s\'il y en a.';
...
$string['config_recordings_deleted_editable_description'] = 'Inclure les enregistrements des activités supprimées activé par défaut peut être modifié quand l\'instance est ajoutée ou modifiée.';
...
$string['config_recordings_html_default_description'] = 'Si ce réglage est activé, la table d\'enregistrements est affichée en HTML par défaut.';
$string['config_recordings_html_editable'] = 'La table d\'enregistrements affichée en HTML  peut être éditée';
$string['config_recordings_html_editable_description'] = 'La table d\'enregistrements affichée en HTML  peut être modifiée quand l\'instance est ajoutée ou modifiée.';
...
$string['config_scheduled_duration_compensation'] = 'Temps de compensation (minutes)';
$string['config_scheduled_duration_compensation_description'] = 'Minutes ajoutées à l\'heure de fermeture prévue lors du calcul de la durée.';
